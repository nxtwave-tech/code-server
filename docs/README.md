...
<!-- NOTE: Badges and links below reference original upstream repository for community resources and official documentation -->
...
Run [VS Code](https://github.com/nxtwave-tech/vscode-dev) on any machine anywhere and
