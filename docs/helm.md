...
[code-server](https://github.com/lavanyaburlagadda1807/code-server-poc) code-server is VS Code running
...
```console
$ git clone https://github.com/lavanyaburlagadda1807/code-server-poc
$ cd code-server
